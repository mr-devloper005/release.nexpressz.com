...
const inputClass = 'h-[3.25rem] rounded-[1.3rem] border border-[var(--slot4-line)] bg-[var(--slot4-warm)] px-4 text-base font-bold text-[var(--slot4-page-text)] outline-none transition placeholder:text-[var(--slot4-muted-text)]/70 focus:border-[var(--slot4-accent-fill)]'
const buttonClass = 'inline-flex h-[3.25rem] items-center justify-center rounded-full bg-[var(--slot4-accent-fill)] px-6 text-xs font-black uppercase tracking-[0.2em] text-white transition hover:translate-y-[-1px] hover:shadow-[0_14px_30px_rgba(131,151,5,0.26)] disabled:opacity-60'
